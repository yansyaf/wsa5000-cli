...
int main(int argc, char *argv[]) {
    ...
    if (argc == 2 && (strcmp(argv[1], "--help") == 0 || strcmp(argv[1], "-h") == 0)) {
        printf("Usage: %s -ip <device_ip> -mode <mode> -atten <attenuator> -fstart <start_freq> -fstop <stop_freq> -scale <scale> -rbw <rbw>\n", argv[0]);
        return 0;
    }
    ...
    // find peak signal in the specified frequency range
